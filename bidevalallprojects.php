...
<body>
  ...
  <div class="page-header" style="text-align: center">
    <table class="head" width="100%">
      <td>
        <img src="outer.png" width="100" height="100" alt="" />
      </td>
      <td>
        ...
        <td>
                    ...
                    <tr>
                      ...
                      <td><br>
                        <strong><?php echo $row['dateOfPosting'] ?><br>
                          <?php echo $row['deadlineOfBid'] ?> - 12:00 noon<br>
                          <br>
          ...
          <div class="page">
            <table width="100%" align="center">
              ...
              <tr align="center">
                <td><strong><span align="center" style="font-size:12px">
                      <p>Table 3. Bid Submission and Opening</p>
                    </span></strong></td>
              </tr>
              <tr>
                <td>
              ...
              <tr align="center">
                <td><strong><span align="center" style="font-size:12px">
                      <p>Table 4. Bid Prices (As Read Out)</p>
                    </span></strong></td>
              </tr>
              <tr>
                <td>
              ...
              <tr align="center">
                <td><strong><span align="center" style="font-size:12px">
                      <p>Table 5. Correction of Bids</p>
                    </span></strong></td>
              </tr>
              <tr>
                <table width="100%" border="1" class="t" align="center">
